...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    api.get(endpoints.violations).then(({ data }) => setData(data.items || []));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="font-display text-2xl">Student Overview</h2>
        <p className="text-white/60">Review and respond to violations.</p>
      </div>
